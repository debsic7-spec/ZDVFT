...
# Dépendances Python
requirements = python3,kivy==2.3.0,kivymd==1.2.0,pillow,requests,certifi,charset-normalizer,idna,urllib3,numpy,pandas,matplotlib,yfinance,plyer,android,pyjnius,multitasking,frozendict,appdirs,platformdirs,pytz,six,python-dateutil,setuptools
